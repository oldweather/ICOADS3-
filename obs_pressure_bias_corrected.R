...
# Month-by-month pressure bias information in ICOADS3+
...
# load the final R3+ obs
o<-ReadObs(sprintf("%s/ICOADS3+/final/IMMA1_R3.0.0_%04d-%02d.gz",
                   datadir,year,month))
...
saveRDS(result,sprintf("%s/ICOADS3+/bias.checks/final_%04d.%02d.Rdata",
                   datadir,year,month))
